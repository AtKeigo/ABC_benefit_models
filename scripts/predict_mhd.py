...
REQUIRED_FEATURES = ["CVR", "RLV", "LLV", "L", "TLV"]


def parse_args():
    parser = argparse.ArgumentParser(
        description="Predict whether mean heart dose (MHD) reduction >20% with ABC compared with FB."
    )
    parser.add_argument(
        "--input",
        type=str,
...
def main():
    ...
    print("prediction = 1 indicates predicted MHD reduction >20% with ABC compared with FB.")
